package com.np.crm.common.memcache.client;
...
import com.np.crm.common.util.DateUtils;
import com.np.crm.common.util.MethodUtil;
...
//	}
	...
	public Object optimizeMethodByMemcached(ProceedingJoinPoint joinpoint) throws Throwable {
		...
		if(value == null){
			...
			// 保存到memcached
			if(timeout > 0)
				memcachedCache.add(cachekey, value, DateUtils.add(new Date(), Calendar.SECOND, timeout));
			else
